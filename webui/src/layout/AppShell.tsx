    ...
    <div className="flex min-h-screen flex-col md:flex-row">
      <aside className="border-b border-slate-800 bg-slate-900/80 md:w-52 md:shrink-0 md:border-b-0 md:border-r">
        ...
        <nav className="-mx-1 flex flex-nowrap gap-1 overflow-x-auto px-2 pb-3 md:mx-0 md:flex-col md:flex-wrap md:overflow-visible">
          ...
          <div className="hidden shrink-0 flex-col gap-1 px-1 pt-2 md:flex">
            <button
              type="button"
              onClick={toggleTheme}
              className="rounded-lg border border-slate-700 px-3 py-2 text-left text-xs text-slate-400 hover:bg-slate-800 hover:text-slate-200"
            >
